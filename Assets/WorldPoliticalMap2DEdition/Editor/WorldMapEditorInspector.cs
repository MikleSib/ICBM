	...
	public class WorldMap2D_EditorInspector : Editor
	{
		...
		void ExecuteMoveTool ()
		{
			...
			for (int i = 0; i < points.Length; i++) {
				...
				var fmh_1337_50_638354928149130315 = mapTransform.rotation; newPoint = Handles.FreeMoveHandle (oldPoint, handleSize, pointSnap,   
		...
		void ExecuteCityMoveTool ()
		{
			...
			#if UNITY_5_6_OR_NEWER
			var fmh_1544_57_638354928149154816 = mapTransform.rotation; Vector3 newPoint = Handles.FreeMoveHandle (oldPoint, handleSize, pointSnap,   
			                                           (handleControlID, position, rotation, size, eventType) =>
			                                           {
		...
		void ExecuteMountPointMoveTool ()
		{
			...
			#if UNITY_5_6_OR_NEWER
			var fmh_1648_57_638354928149162628 = mapTransform.rotation; Vector3 newPoint = Handles.FreeMoveHandle (oldPoint, handleSize, pointSnap,   
			                                           (handleControlID, position, rotation, size, eventType) =>
			                                           {
				Handles.RectangleHandleCap (handleControlID, position, rotation, size, eventType);
			});
