    ...
    public partial class WMSKEditorInspector : Editor {
        ...
        void ExecuteMoveTool(Vector2 mousePosition) {
            ...
            for (int i = 0; i < points.Length; i++) {
                ...
                var fmh_1910_61_638357314263464305 = mapTransform.rotation; newPoint = Handles.FreeMoveHandle(oldPoint, handleSize, pointSnap,
        ...
        void ExecuteCityMoveTool() {
            ...
            var fmh_2089_65_638357314263491881 = mapTransform.rotation; Vector3 newPoint = Handles.FreeMoveHandle(oldPoint, handleSize, pointSnap,
                                                   (handleControlID, position, rotation, size, eventType) => {
        ...
        void ExecuteMountPointMoveTool() {
            ...
            var fmh_2175_65_638357314263499666 = mapTransform.rotation; Vector3 newPoint = Handles.FreeMoveHandle(oldPoint, handleSize, pointSnap,
                                                                   (handleControlID, position, rotation, size, eventType) => {
                                                                       Handles.RectangleHandleCap(handleControlID, position, rotation, size, eventType);
                                                                   });
            if (newPoint != oldPoint) {
