...
namespace WorldMapStrategyKit {
    ...
    public partial class WMSK : MonoBehaviour {
        ...
        void UpdateFrontiersMaterial() {
            ...
            frontiersMat.SetColor(ShaderIds.OuterColor, frontiersColorOuter);
            frontiersMat.SetFloat(ShaderIds.Thickness, _frontiersWidth);
            frontiersMat.SetFloat(ShaderIds.MaxPixelWidth, _frontiersMaxPixelWidth);
            UpdateShadersLOD();
