        ...
        void DrawTextMeshProLabels() {
            ...
            for (int countryIndex = 0; countryIndex < _countries.Length; countryIndex++) {
                ...
                if (_countryLabelsOutlineWidth > 0) {
                    fontMat.SetColor(ShaderIds.OutlineColor, _countryLabelsOutlineColor);
                    fontMat.SetFloat(ShaderIds.OutlineWidth, _countryLabelsOutlineWidth);
                    fontMat.EnableKeyword(ShaderIds.SKW_OUTLINE);
                } else {
                    fontMat.DisableKeyword(ShaderIds.SKW_OUTLINE);
                }
